<!-- agentic-artifact:
  ...
  id: education.profiles.storytelling-profile
  version: 1
  status: active
  layer: 05.education
  domain: education
  ...
  - agentic
  kind: guide
  purpose: Document Storytelling Profile.
  portability:
    class: required
    targets:
    - llm-workbench
...
- A specific moment first
- The problem I thought I was solving
- The problem I was actually solving
- Tension before lesson
- Concrete evidence before abstraction
- A clean landing rather than a grand universal claim

## Avoid

- Mechanical commit summaries
