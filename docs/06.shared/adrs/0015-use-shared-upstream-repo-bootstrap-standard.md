...
id: harness.adr.0015-use-shared-upstream-repo-bootstrap-standard
version: 1
status: active
layer: 06.shared
domain: architecture
...
- architecture
kind: adr
purpose: Record the 0015 Use Shared Upstream Repo Bootstrap Standard architecture
  decision.
portability:
  class: source-only
  targets: []
...
- id: shared.adrs.readme
  path: docs/06.shared/adrs/README.md
-->
