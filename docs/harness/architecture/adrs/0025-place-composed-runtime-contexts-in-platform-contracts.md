...
id: harness.architecture.adr.0025-place-composed-runtime-contexts-in-platform-contracts.pointer
version: 1
status: active
layer: 01.harness
domain: architecture
...
purpose: Point older ADR 0025 references to the product-layer canonical ADR.
portability:
  class: source-only
  targets: []
used_by:
