...
id: harness.adr.0005-preserve-bootstrap-dirty-worktree-before-workflow-loading
version: 1
status: active
layer: 01.harness
domain: architecture
...
- architecture
kind: adr
purpose: Record the 0005 Preserve Bootstrap Dirty Worktree Before Workflow Loading
