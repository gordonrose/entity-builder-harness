...
id: harness.adr.0005-preserve-bootstrap-dirty-worktree-before-workflow-loading.pointer
version: 1
status: active
layer: 01.harness
domain: architecture
...
purpose: Point older ADR 0005 references to the chat-layer canonical ADR.
portability:
  class: source-only
  targets: []
used_by:
