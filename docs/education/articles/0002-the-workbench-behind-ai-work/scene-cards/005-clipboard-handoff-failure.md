<!-- agentic-artifact:
  ...
  id: education.articles.0002-the-workbench-behind-ai-work.scene-cards.005-clipboard-handoff-failure
  version: 1
  status: active
  layer: 04.education
  domain: education
  ...
  - agentic
  kind: guide
  purpose: 'Document Scene Card: Clipboard Handoff Failure.'
  portability:
    class: required
    targets:
    - llm-workbench
