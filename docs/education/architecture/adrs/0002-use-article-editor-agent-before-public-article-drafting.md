<!-- agentic-artifact:
  ...
  id: education.architecture.adr.0002-use-article-editor-agent-before-public-article-drafting
  version: 1
  status: active
  layer: 05.education
  domain: education
  ...
  - agentic
  kind: adr
  purpose: Document 0002 Use Article Editor Agent Before Public Article Drafting.
  portability:
    class: required
    targets:
    - llm-workbench
