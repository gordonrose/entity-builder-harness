...
const runtimeRoot = ".cache/app-platform-smoke-runtime";
const testDirectory = join(runtimeRoot, "apps/platform-smoke/tests");
const coreModules = [
  "audit",
  "authn",
  "authz",
...
if (testFiles.length === 0) {
  throw new Error(`No platform-smoke runtime tests found in ${testDirectory}.`);
}
