...
const runtimeRoot = ".cache/platform-workers-runtime";
const testDirectory = join(runtimeRoot, "platform/workers/tests");
const coreModules = [
  "audit",
  "authn",
  "authz",
...
if (testFiles.length === 0) {
  throw new Error(`No platform/workers runtime tests found in ${testDirectory}.`);
}
