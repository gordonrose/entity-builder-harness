...
const runtimeRoot = ".cache/platform-runtime-runtime";
const testDirectory = join(runtimeRoot, "platform/runtime/tests");
const coreModules = [
  "audit",
  "authn",
  "authz",
...
if (testFiles.length === 0) {
  throw new Error(`No platform/runtime runtime tests found in ${testDirectory}.`);
}
