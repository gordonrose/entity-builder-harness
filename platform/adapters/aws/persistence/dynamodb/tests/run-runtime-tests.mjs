...
const runtimeRoot = ".cache/platform-adapter-aws-persistence-dynamodb-runtime";
const coreModules = [
  "diagnostics",
  "monitoring",
  "persistence",
...
const result = spawnSync(
  process.execPath,
  [join(runtimeRoot, "platform/adapters/aws/persistence/dynamodb/tests/dynamodb-persistence-adapter-runtime.test.js")],
  { stdio: "inherit" },
);
