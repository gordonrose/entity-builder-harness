...
# agentic-script:
#   owner: 00.chat
#   purpose: Compatibility wrapper for chat commit-boundary readiness checks.
#   domain: session-log
...
exec bash scripts/00.chat/session-log/prepare-chat-session-before-commit/script.sh "$@"
