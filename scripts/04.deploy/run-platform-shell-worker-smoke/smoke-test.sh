...
if [[ "$result" != *'"worker_smoke":"validated"'* ]] || [[ "$result" != *'"message_count":2'* ]] || [[ "$result" != *'"inter_message_wait_seconds":75'* ]] || [[ "$result" != *'"maximum_wait_seconds":360'* ]] || [[ "$result" != *'"metric_export_settlement_wait_seconds":75'* ]]; then
